...
template.innerHTML = `
  <style>
:host { display: block; }
.forgot { width: 100%; display: flex; flex-direction: column; gap: var(--space-5); }
...
.forgot__security-note p { font-size: var(--text-xs); color: var(--color-text-muted); line-height: 1.6; margin: 0; }
  ...
  <div class="forgot">
    ...
    <div class="forgot__icon">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
    </div>
